...
function searchTracksbyName(name, color, orientation, res, colorGiven) {
    return __awaiter(this, void 0, void 0, function* () {
        let totalArtist;
        let artistList = [];
        let artistString = "";
        let songName;
        let imageURL;
        var width, height, imageX, imageY, imageWidth, imageHeight, songX, songY, songFont, songNameX, songNameY, songArtistX, songArtistY, songArtistFont, bottomTextX, bottomTextY, bottomTextFont, dmX, dmY, dmW, dmH;
        const text = "SONG";
        ...
        const data = yield spotifyApi.searchTracks(name, {
            market: "US",
            limit: 1,
            offset: 0,
        });
        ...
        fs.writeFile(path.resolve(__dirname, "logo/Spotify_logo_with_text.svg"), new_svg_text, function (err) {
            if (err) {
...
function searchTracksbyID(id, color, orientation, res, colorGiven) {
    return __awaiter(this, void 0, void 0, function* () {
        let totalArtist;
        let artistList = [];
        let artistString = "";
        ...
        var data;
        try {
            data = yield spotifyApi.getTrack(id, { market: "US", limit: 1, offset: 5 });
        }
        catch (e) {
            res.send("Invalid ID");
            return false;
